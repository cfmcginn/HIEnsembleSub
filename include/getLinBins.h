...
void getLinBins(const Float_t lower, const Float_t higher, const Int_t nBins, Float_t bins[])
{
  bins[0] = lower;
  bins[nBins] = higher;
...
void getLinBins(const Float_t lower, const Float_t higher, const Int_t nBins, Int_t bins[])
{
  bins[0] = lower;
  bins[nBins] = higher;
